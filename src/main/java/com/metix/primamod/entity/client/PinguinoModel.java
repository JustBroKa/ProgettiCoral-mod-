...
public class PinguinoModel<T extends Entity> extends HierarchicalModel<T> {
    private final ModelPart pinguino;
    private final ModelPart head;

    public PinguinoModel(ModelPart root) {
        this.pinguino = root.getChild("rhino");
        this.head = pinguino.getChild("pinguino").getChild("head");
    }
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        pinguino.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }
